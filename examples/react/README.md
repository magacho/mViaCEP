# mViaCEP — exemplo React

App Vite + React mínimo que usa o hook `useViaCep()` de `mviacep/react` para
montar um formulário de CEP com autopreenchimento.
...
pois os subpaths (`mviacep/react`) resolvem para `dist/`.
